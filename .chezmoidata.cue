...
aliases: {
	...
	prd:             "pr --draft"
	prm:             "pnpm remove"
	prune:           "duf /; \(dspa); brew cleanup; go clean -modcache; pnpm store prune --force; rm -rf ~/.cache/uv ~/.minikube ~/.npm ~/.pulumi/plugins ~/.rustup; rustup default stable; duf /"
	prw:             "gh pr view --web"
	...
	sr:              "./snapshot.sh remove-projects"
	sri:             "./snapshot.sh restore init"
	ssi:             "./snapshot.sh delete init && ./snapshot.sh save init"
