...
aliases: {
	...
	b:               "bat"
	bf:              "git -C ~/thebengeu/qmk_firmware switch --recurse-submodules sofleplus2 && \(_env) --chdir ~/thebengeu/qmk_userspace make hazel/bad_wings:thebengeu:flash"
	c:               "docker compose"
	...
	ka:              "kubectl apply -f"
	kc:              "kubectl create -f"
	kf:              "git -C ~/thebengeu/qmk_firmware switch --recurse-submodules holykeebs-master && \(_env) --chdir ~/thebengeu/qmk_userspace make keyball/keyball44:thebengeu:flash"
	...
	uc:              "git -C ~/thebengeu/qmk_firmware switch --recurse-submodules sofleplus2 && qmk userspace-compile"
