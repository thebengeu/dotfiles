...
aliases: {
	...
	ka:              "kubectl apply -f"
	kc:              "kubectl create -f"
	kf:              "git -C ~/thebengeu/qmk_firmware sw holykeebs-master && \(_env) --chdir ~/thebengeu/qmk_userspace make keyball/keyball44:thebengeu:flash"
