...
If A_Args.has(1) {
  ...
  ^+!d::ActivateMinimizeOrRun("Todoist ahk_exe msedge.exe", "explorer.exe shell:AppsFolder\app.todoist.com-4794784_5r3ptnqrybf3c!App")
  ^+!e::ActivateMinimizeOrRun("Edge ahk_exe msedge.exe", A_ProgramsCommon . "\Microsoft Edge")
  ^+!m::ActivateMinimizeOrRun("ahk_exe Spark Desktop.exe", A_Programs . "\Spark Desktop")
  ...
  ^+!t::ActivateMinimizeOrRun("Unigram ahk_exe ApplicationFrameHost.exe", "explorer.exe shell:AppsFolder\38833FF26BA1D.UnigramPreview_g9c9v27vpyspw!App")
